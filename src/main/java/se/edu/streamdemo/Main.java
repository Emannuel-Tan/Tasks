...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Task> filteredList = filerByStringUsingStream(tasksData, "11");
    ...
    public static ArrayList<Task> filerByStringUsingStream(ArrayList<Task> tasks, String filterString) {
